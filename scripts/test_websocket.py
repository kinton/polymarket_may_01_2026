...
YES_TOKEN = (
    "13370581172933891391113066595640479132762698108064247290749242889130004119813"
)
NO_TOKEN = (
    "104789774317139575915064985340875383502299301877454707730952703602618274765937"
)
    ...
    async with websockets.connect(WS_URL, ping_interval=20, ping_timeout=10) as ws:
        ...
        for i in range(10):
            try:
                ...
                token_name = (
                    "YES" if is_yes else "NO" if asset_id == NO_TOKEN else "???"
                )
